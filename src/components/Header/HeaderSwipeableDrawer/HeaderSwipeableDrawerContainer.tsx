...
export const HeaderSwipeableDrawerContainer = ({
  handleCreateRecipeClick,
  handleRecipeBuilderClick,
}: HeaderSwipeableDrawerContainerProps) => {
  ...
  const buttonList = [
    {
      ...
      icon: <Add />,
      handler: handleCreateRecipeClick,
    },
    {
      name: 'Контруктор рецепта',
      icon: <AutoFixHighOutlinedIcon />,
      handler: handleRecipeBuilderClick,
    },
  ];
