...
export const MyRecipesContainer = () => {
  ...
  return (
    <Container sx={{pt: 4}}>
      {recipes.length === 0
        ? <Typography variant="h5" gutterBottom component="div">Вы не добавили ни одного рецепта</Typography>
        : <Typography variant="h5" gutterBottom component="div">Добавленные вами рецепты</Typography>}
