import React, { useCallback, Dispatch, SetStateAction, ChangeEvent, useState } from "react";
...
export const CreateInstructionContainer = ({ setInstructionList, id, instruction, isEditForm, setIsLoadFile, isLoadFile, selectedFiles, setSelectedFiles }: CreateInstructionContainerProps) => {
